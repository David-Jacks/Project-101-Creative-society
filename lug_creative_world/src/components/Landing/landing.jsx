    ...
    <>
      <div id="landing_page_wrapper">
        <header>
          ...
          <ul>
            <li>
              <Link to="/about" className="link hvr-curl-top-right">
                About
              </Link>
            </li>
            <li>
              <a
                href="https://weblogin.lancs.ac.uk/login/?cosign-https-modules.lancaster.ac.uk&https://ghana-modules.lancaster.ac.uk/login/index.php"
                className="link hvr-curl-top-right"
                target="absolute"
              >
                Portal
              </a>
            ...
            <li>
              <Link to="/loginpage" className="link hvr-curl-top-right">
                Sign In
              </Link>
            </li>
          </ul>
        ...
        <section className="section_1">
          <div className="section_text">
            <div className="text_main_side">
              ...
              <p>
                Explore a world of writing and reading
                <br />
                skills
              </p>
            </div>
